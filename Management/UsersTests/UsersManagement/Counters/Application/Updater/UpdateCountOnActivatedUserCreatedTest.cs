...
public class UpdateCountOnActivatedUserCreatedTest : CountersModuleApplicationUnitTestCase
{
    private readonly UsersCounterUpdater _updateCounter;
    private readonly UsersCounterFinder _finder;
    private readonly UpdateCountOnActivatedUserCreated _updateCountOnActivatedUserCreated;
    public UpdateCountOnActivatedUserCreatedTest()
    {
        ...
        this._updateCountOnActivatedUserCreated = new UpdateCountOnActivatedUserCreated(this._updateCounter);
    }
    ...
    public void ShouldCallUpdateOnce()
    {
        ...
        ActivatedUserCreated activatedUserCreatedDomainEvent = ActivatedUserCreated.Create(
            user.Id.Id,
            user.Name.Name,
            user.Email.Email,
            user.State.Active
        ...
        // WHEN
        this._updateCountOnActivatedUserCreated.OnAsync((DomainEvent)activatedUserCreatedDomainEvent);
        // THEN
        this.ShouldHaveCalledUpdateOnceWithCorrectParameters(count);
    }

    [Fact]
    public void ShouldUpdateCountOnActivatedUserCreated()
    {
        // GIVEN
        Usuario user = UserMother.CreateRandom();
        ActivatedUserCreated activatedUserCreatedDomainEvent = ActivatedUserCreated.Create(
